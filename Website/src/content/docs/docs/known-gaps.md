...
**Auto-update has only run against a test feed.** A throwaway app, embedded and signed by the same
scripts as Eskele, updated itself through a local appcast and refused a forged one. The release
